...
class FaceRecognitionApp:
    def __init__(self, root, imageFacesPath):
        ...
        self.root.geometry("800x600")  # Cambia las dimensiones según tus necesidades
        ...
        self.add_song_button = tk.Button(root, text="Add Song", command=self.add_song_to_queue)
        ...
        while not self.stop_event.is_set():
            ...
            for (x, y, w, h) in faces:
                ...
                try:
                    ...
                    continue  # Skip the current face if encoding fails
