...
def reconocimiento_facial(imageFacesPath):
    ...
    frame_skip = 2  # Saltar 1 de cada 2 frames para lograr 15 FPS (suponiendo que la cámara capta a 30 FPS)
    ...
    while True:
        ...
        # Procesar y mostrar solo uno de cada `frame_skip` fotogramas
